...
return function(Config)
    ...
    if Window.User.Enabled then
        local ImageId, _ = game:GetService("Players"):GetUserThumbnailAsync(
            Window.User.Anonymous and 1 or game:GetService("Players").LocalPlayer.UserId, 
        ...
        UserIcon = New("TextButton", {
            ...
            Creator.NewRoundFrame(Window.UICorner-(Window.UIPadding/2), "Squircle", {
                ...
                New("Frame", {
                    ...
                    New("TextLabel", {
                        Text = Window.User.Anonymous and "Anonymous" or game:GetService("Players").LocalPlayer.DisplayName,
                        TextSize = 17,
                        ThemeTag = {
                            TextColor3 = "Text",
                        },
                    ...
                    New("TextLabel", {
                        Text = Window.User.Anonymous and "@anonymous" or "@" .. game:GetService("Players").LocalPlayer.Name,
                        TextSize = 15,
                        TextTransparency = .6,
                        ThemeTag = {
                            TextColor3 = "Text",
